...
class Brewery(App):
	...
	def main(self):
		...
		self.btUploadFile = gui.FileUploader('./',  style = {'width':'25%', 'color' :'white', 'background-color' :'black', 'white' : '2.5vw',  'height':'3.0%', 'left': '70%', 'margin':'auto', 'top': '96%', 'display' : 'block', 'position' :'absolute', 'z-index' : '1'})
		...
		self.pause_on = gui.Button('Unpause',  style = {'width':'8%', 'color' :'black', 'background-color' :'red', 'font-size' : '2.2vw',  'height':'4.0%', 'left': '75%', 'margin':'auto', 'top': '91%', 'display' : 'block', 'position' :'absolute', 'z-index' : '1'})
		self.pause_on.set_on_click_listener(self.on_pause_pressed)
		...
		verticalContainer.append(self.pause_on)
	...
	def fileupload_on_success(self, widget, filename):
		fileupload = False
		global instructions, fileupload
		try:
			print(str(filename))
...
#				#data.readline()
	...
	def run_brewery(self):
		global target_temp1, target_temp2, instructions, step, start_time, total_start_time, fileupload, pause, heater2
