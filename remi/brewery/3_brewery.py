...
data = serial.Serial(port='/dev/cu.SLAB_USBtoUART', baudrate=9600, parity=serial.PARITY_NONE, stopbits=serial.STOPBITS_ONE,bytesize=8,timeout=2) 
#data = serial.Serial(port='/dev/cu.SLAB_USBtoUART', baudrate=9600)# parity=serial.PARITY_NONE, stopbits=serial.STOPBITS_ONE,bytesize=8,timeout=1) 
...
class Brewery(App):
	...
	def main(self):
		...
		self.u_current_temp1 = gui.Label(' Current temp 1:', style = {'width' : '20%', 'height' : '4%', 'padding-top' : '.8%', 'color': '#75e7ff', 'left' : '3%', 'background-color': "black", 'line-height' :'100%', 'position' : 'absolute', 'font-weight':'bold', 'font-size' : '1.5vw', 'top' : '74%', 'text-align':'left', 'padding-left': '.8%', 'z-index' : '0'})
		self.u_current_temp1_val = gui.Label('0 \u2103', style = {'width' : '8%', 'height' : '4%', 'padding-top' : '.8%', 'color': 'grey', 'left' : '16%', 'background-color': "black", 'line-height' :'100%', 'position' : 'absolute', 'font-weight':'bold', 'font-size' : '1.5vw', 'top' : '74%', 'text-align':'left', 'padding-left': '0%', 'z-index' :'1'})

		self.u_current_temp2 = gui.Label(' Current temp 2:', style = {'width' : '20%', 'height' : '4%', 'padding-top' : '.8%', 'color': '#75e7ff', 'left' : '3%', 'background-color': "black", 'line-height' :'100%', 'position' : 'absolute', 'font-weight':'bold', 'font-size' : '1.5vw', 'top' : '78%', 'text-align':'left', 'padding-left': '.8%', 'z-index' : '0'})
		self.u_current_temp2_val = gui.Label('0 \u2103', style = {'width' : '8%', 'height' : '4%', 'padding-top' : '.8%', 'color': 'grey', 'left' : '16%', 'background-color': "black", 'line-height' :'100%', 'position' : 'absolute', 'font-weight':'bold', 'font-size' : '1.5vw', 'top' : '78%', 'text-align':'left', 'padding-left': '0%', 'z-index' :'1'})

		self.u_current_temp3 = gui.Label(' Current temp 3:', style = {'width' : '20%', 'height' : '4%', 'padding-top' : '.8%', 'color': '#75e7ff', 'left' : '3%', 'background-color': "black", 'line-height' :'100%', 'position' : 'absolute', 'font-weight':'bold', 'font-size' : '1.5vw', 'top' : '82%', 'text-align':'left', 'padding-left': '.8%', 'z-index' : '0'})
		self.current_temp3_val = gui.Label('0 \u2103', style = {'width' : '8%', 'height' : '4%', 'padding-top' : '.8%', 'color': 'grey', 'left' : '16%', 'background-color': "black", 'line-height' :'100%', 'position' : 'absolute', 'font-weight':'bold', 'font-size' : '1.5vw', 'top' : '82%', 'text-align':'left', 'padding-left': '0%', 'z-index' :'1'})

		self.u_current_temp4 = gui.Label(' Current temp 4:', style = {'width' : '20%', 'height' : '4%', 'padding-top' : '.8%', 'color': '#75e7ff', 'left' : '3%', 'background-color': "black", 'line-height' :'100%', 'position' : 'absolute', 'font-weight':'bold', 'font-size' : '1.5vw', 'top' : '86%', 'text-align':'left', 'padding-left': '.8%', 'z-index' : '0'})
		self.current_temp4_val = gui.Label('0 \u2103', style = {'width' : '8%', 'height' : '4%', 'padding-top' : '.8%', 'color': 'grey', 'left' : '16%', 'background-color': "black", 'line-height' :'100%', 'position' : 'absolute', 'font-weight':'bold', 'font-size' : '1.5vw', 'top' : '86%', 'text-align':'left', 'padding-left': '0%', 'z-index' :'1'})

		self.u_current_temp5 = gui.Label(' Current temp 5:', style = {'width' : '20%', 'height' : '4%', 'padding-top' : '.8%', 'color': '#75e7ff', 'left' : '3%', 'background-color': "black", 'line-height' :'100%', 'position' : 'absolute', 'font-weight':'bold', 'font-size' : '1.5vw', 'top' : '90%', 'text-align':'left', 'padding-left': '.8%', 'z-index' : '0'})
		self.current_temp5_val = gui.Label('0 \u2103', style = {'width' : '8%', 'height' : '4%', 'padding-top' : '.8%', 'color': 'grey', 'left' : '16%', 'background-color': "black", 'line-height' :'100%', 'position' : 'absolute', 'font-weight':'bold', 'font-size' : '1.5vw', 'top' : '90%', 'text-align':'left', 'padding-left': '0%', 'z-index' :'1'})
		...
		verticalContainer.append(self.u_current_temp1)
		verticalContainer.append(self.u_current_temp2)
		verticalContainer.append(self.u_current_temp3)
		verticalContainer.append(self.u_current_temp4)
		verticalContainer.append(self.u_current_temp5)
		verticalContainer.append(self.u_current_temp1_val)
		verticalContainer.append(self.u_current_temp2_val)
		verticalContainer.append(self.current_temp3_val)
		verticalContainer.append(self.current_temp4_val)
		verticalContainer.append(self.current_temp5_val)
	...
	def relay_go(self, _):
		if self.check_on == "true":
			...
			try:
				...
				print("RELAY START WAITING")
				self.wait(int(self.relay_time))
				print("RELAY DONE WAITING")
	...
	def get_temp(self):
		global current_temp1, current_temp2, current_temp3, current_temp4, current_temp5
		#try:
		current_temp1 = ""
		while True:
			onebyte = data.read(1)
			if onebyte == b"\r":    #method should returns bytes
				print (current_temp1[5:10])
				break
			else:
				current_temp1 += onebyte.decode()
		current_temp1 = float(current_temp1[5:10])
		current_temp2 = ""
		while True:
			onebyte = data.read(1)
			if onebyte == b"\r":    #method should returns bytes
				print (current_temp2[5:10])
				break
			else:
				current_temp2 += onebyte.decode()
		current_temp2 = float(current_temp2[5:10])
		current_temp3 = ""
		while True:
			onebyte = data.read(1)
			if onebyte == b"\r":    #method should returns bytes
				print (current_temp3[5:10])
				break
			else:
				current_temp3 += onebyte.decode()
		current_temp3 = float(current_temp3[5:10])
		current_temp4 = ""
		while True:
			onebyte = data.read(1)
			if onebyte == b"\r":    #method should returns bytes
				print (current_temp4[5:10])
				break
			else:
				current_temp4 += onebyte.decode()
		current_temp4 = float(current_temp4[5:10])
		current_temp5 = ""
		while True:
			onebyte = data.read(1)
			if onebyte == b"\r":    #method should returns bytes
				print (current_temp5[5:10])
				break
			else:
				current_temp5 += onebyte.decode()
		current_temp5 = float(current_temp5[5:10])
	...
	def maintain_temp(self):
		...
		global target_temp1, target_temp2, current_temp1, current_temp2, current_temp3, current_temp4, current_temp5
		self.get_temp()
	...
	def set_temp1(self):
		global target_temp1, heater1, current_temp1, current_temp2, current_temp3, current_temp4, current_temp5
		temp_array = [1,2]
		current_temp_old = 0
		current_temp_new = 0
		counter = 0
		self.fire_img.set_image('res/fire.png')
		print("CALLED SET TEMP!!!!")
		self.get_temp()
		try:
			# turn heater 1 on
			print("Turning on heater 1")
...
if __name__ == "__main__":
        ...
        v.open_path(b'IOService:/AppleACPIPlatformExpert/PCI0@0/AppleACPIPCI/XHC1@14/XHC1@14000000/HS01@14100000/USB2.0 Hub@14100000/AppleUSB20Hub@14100000/AppleUSB20HubPort@14110000/USBRelay8@14110000/IOUSBHostInterface@0/IOUSBHostHIDDevice@14110000,0')

        h = hid.device()
        h.open_path(b'IOService:/AppleACPIPlatformExpert/PCI0@0/AppleACPIPCI/XHC1@14/XHC1@14000000/HS01@14100000/USB2.0 Hub@14100000/AppleUSB20Hub@14100000/AppleUSB20HubPort@14120000/USBRelay8@14120000/IOUSBHostInterface@0/IOUSBHostHIDDevice@14120000,0')
